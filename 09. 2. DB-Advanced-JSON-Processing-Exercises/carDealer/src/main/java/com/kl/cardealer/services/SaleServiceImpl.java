...
import com.kl.cardealer.domain.dtos.query6_salesDiscounts_dtos.CarSaleDiscountDto;
...
public class SaleServiceImpl implements SaleService {
    ...
    @Override
    public List<SaleDiscountDto> getSalesWithDiscount() {
        List<Sale> saleList = this.saleRepository.findAll();

        List<SaleDiscountDto> saleDiscountDtos = saleList.stream().map(sale -> {
            SaleDiscountDto saleDiscountDto = new SaleDiscountDto();
            CarSaleDiscountDto carSaleDiscountDto = new CarSaleDiscountDto();

            carSaleDiscountDto.setMake(sale.getCar().getMake());
            carSaleDiscountDto.setModel(sale.getCar().getModel());
            carSaleDiscountDto.setTravelledDistance(sale.getCar().getTravelledDistance());
            ...
            saleDiscountDto.setCar(carSaleDiscountDto);
            ...
            saleDiscountDto.setPriceWithDiscount(new BigDecimal(String.format("%.2f",carPriceWithDiscount)));
